        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-black border border-black font-semibold rounded-lg transition-all duration-200 hover:bg-gray-100 hover:shadow"
            >
